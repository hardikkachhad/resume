                ...
                <div class="row portfolio-container">
                    <div class="col-lg-4 col-md-6 portfolio-item web-des">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('admin_assets/img/portfolio-1.jpg') }}" class="img-fluid" alt="">
                                <a href="{{ asset('admin_assets/img/portfolio-1.jpg') }}" data-lightbox="portfolio" data-title="Project Name" class="link-preview" title="Preview"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-des">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('admin_assets/img/portfolio-2.jpg') }}" class="img-fluid" alt="">
                                <a href="{{ asset('admin_assets/img/portfolio-2.jpg') }}" class="link-preview" data-lightbox="portfolio" data-title="Project Name" title="Preview"><i class="fa fa-eye"></i></a>
                                <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                                <a class="portfolio-title" href="#">Project Name <span>Web Design</span></a>
                            </figure>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('admin_assets/img/portfolio-3.jpg') }}" class="img-fluid" alt="">
                                <a href="{{ asset('admin_assets/img/portfolio-3.jpg') }}" class="link-preview" data-lightbox="portfolio" data-title="Project Name" title="Preview"><i class="fa fa-eye"></i></a>
                                <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="{{ asset('admin_assets/img/portfolio-4.jpg') }}" class="img-fluid" alt="">
                                <a href="{{ asset('admin_assets/git branch -M mainimg/portfolio-4.jpg') }}" class="link-preview" data-lightbox="portfolio" data-title="Project Name" title="Preview"><i class="fa fa-eye"></i></a>
                                <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                                <a class="portfolio-title" href="#">Project Name <span>Web Development</span></a>
                            </figure>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="contact-info">
                            ...
                            <p><i class="fa fa-envelope"></i><a href="mailto:info@example.com">hardikkachhad08@gmail.com</a></p>
